...
class SelfForcingTrainingPipeline:
    def __init__(self,
        ...
        self.gradient_window_frames = gradient_window_frames
        self.i2v = False
    ...
    def inference_with_trajectory(
        ...
        for block_index, current_num_frames in enumerate(all_num_frames):
            ...
            # Step 3.3: commit a context-noised copy of the generated block to
            # K/V. The output itself stays clean; only future blocks attend to
            # the noised representation.
    ...
    def _initialize_kv_cache(self, batch_size, dtype, device):
        ...
        if hasattr(self.generator, "initialize_kv_cache"):
            self.kv_cache1 = self.generator.initialize_kv_cache(
                max_frames=self.kv_cache_size // self.frame_seq_length,
                batch_size=batch_size,
                dtype=dtype,
                device=device,
            )
